...
public class TestVoiceActivity extends AppCompatActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, TestVoiceActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIat = SpeechRecognizer.createRecognizer(TestVoiceActivity.this, mInitListener);

        // 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(TestVoiceActivity.this, mInitListener);

        mSharedPreferences = getSharedPreferences(SetYysrConfig.PREFER_NAME,
...
//                // 移动数据分析，收集开始听写事件
//                FlowerCollector.onEvent(TestVoiceActivity.this, "iat_recognize");
